...
import cmd, uuid, jwt, json, hashlib, logging, os, hmac, secrets, subprocess, random, re, time, string, sys, shlex, stat, time, threading
...
socketio = SocketIO(app, logging=False, cors_allowed_origins="*", async_mode='gevent')
...
def get_user_save_file(username):
    ...
    return os.path.join(save_dir, f'{username}_story_save.json')
...
@app.route('/api/journal/entry/<entry_id>')
...
# ==================== ADMIN PANEL ====================
ADMIN_LEVEL_FILE = 'admin_levels.json'

def load_admin_levels():
    """Carrega os níveis de admin dos usuários"""
    try:
...
@app.route('/api/admin/user/<target_username>/admin-level', methods=['PUT'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/force-end', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/sync')
@admin_required
...
@app.route('/api/admin/game/<game_id>/kick/<target_username>', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/state')
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/give-card', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/remove-card', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/modify-life', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/modify-hand', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/field', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/set-turn', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/set-time', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/deck/shuffle', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/deck/peek', methods=['GET'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/graveyard/revive', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/kill', methods=['POST'])
@admin_required
...
@app.route('/api/admin/game/<game_id>/player/<target_username>/revive', methods=['POST'])
@admin_required
...
@app.route('/api/admin/cards/list')
@admin_required
